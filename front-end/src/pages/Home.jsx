...
function CollectionPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get('https://baghub-by-mohammed.onrender.com/home');
  ...
  return (
    ...
    <div className="baghub-productlist-outer">
     ...
     <section className="baghub-hero-banner-home">
        <div className="baghub-hero-content-home">
          <h1 className="baghub-hero-title-home">Find Your Perfect Bag at BAGHUB</h1>
          <p className="baghub-hero-subtitle-home">
            Elegant, stylish, and high-quality bags curated just for you.
            Shop your dream bag today.
          </p>
          <button
            className="baghub-hero-btn-home"
      ...
      <Link to="/collections" className="baghub-view-all-link">
